...
var AppConstants = (function () {
    ...
    AppConstants.FETCH_LIST_OF_STATES_BY_CNTRY_ID = '/StateAPI/get/';
    AppConstants.FETCH_LIST_OF_CITIES_BY_STATE_ID = '/CityAPI/get/';
    ...
    AppConstants.IMPORT_PATIENTS_MAP_FIELDS = '/patient/importPatientMapFields';
    AppConstants.IMPORT_PATIENTS_SAVE_MAP_FIELDS = '/patient/importPatientSaveMapping';
    AppConstants.IMPORT_PATIENTS_IMPORT_MAPPED_DATA = '/patient/importPatientImportMappedData';
    AppConstants.IMPORT_PATIENTS_SAVE_MAPPED_DATA = '/patient/importPatientSaveMappedData';
